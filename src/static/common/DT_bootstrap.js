...
$.extend( true, $.fn.dataTable.defaults, {
    ...
    "oLanguage" : {
        ...
        "sProcessing": "正在加载中...",
        "sSearch": "搜索:",
        "sUrl": "", //多语言配置文件，可将oLanguage的设置放在一个txt文件中
        "oPaginate": {
            "sFirst": "首页",
            "sPrevious": "前一页",
            "sNext": "后一页",
...
/* Bootstrap style full number pagination control -xjch*/
$.extend( $.fn.dataTableExt.oPagination, {
    "bootstrap_extended_jump": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            var oLang = oSettings.oLanguage.oPaginate;
            var oPaging = oSettings.oInstance.fnPagingInfo();
            ...
            $(nPaging).append(
                ...
                '<a href="#" class="paginate_button btn btn-sm default prev disabled" title="' + oLang.sFirst + '">' + oLang.sFirst + '</a> ' +
                '<a href="#" class="paginate_button btn btn-sm default prev disabled" title="' + oLang.sPrevious + '">' + oLang.sPrevious + '</a> ' +
                '<a href="#" class="paginate_button btn btn-sm default next disabled" title="' + oLang.sNext + '">' + oLang.sNext + '</i></a> ' +
                '<a href="#" class="paginate_button btn btn-sm default next disabled" title="' + oLang.sLast + '">' + oLang.sLast + '</i></a> ' +
                oLang.sPage +
                '<input type="text" class="pagination-panel-input input-xmini input-inline" maxlenght="5" style="width:40px">' +
                oLang.sPageOf + ' 共<span class="pagination-panel-total"></span>页' +
                '</div>'
            );
